        ...
        <main class="min-h-screen lg:grid lg:grid-cols-2">
            ...
            <section class="flex min-h-screen items-center justify-center px-6 py-8 sm:px-16 lg:px-20">
                <div class="w-full max-w-[560px]">
                    ...
                    <form class="space-y-5" data-firebase-register>
                        @csrf
                        <div>
                        ...
                        <div>
                            ...
                            <input id="password" name="password" type="password" autocomplete="new-password" placeholder="At least 10 characters" class="guild-input" required>
                            @error('password') <p class="mt-2 text-sm text-[#c04e2b]">{{ $message }}</p> @enderror
                        </div>
                        <p class="-mt-2 text-sm text-[#817b76]">Use at least 10 characters, including one uppercase letter and one special character.</p>
                        <div>
                        ...
                        <p class="text-sm text-[#817b76]">After registering, Firebase will send a verification link to your email.</p>
